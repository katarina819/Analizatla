...
namespace BACKEND.Services
{
    ...
    public class SlikaService
    {
        ...
        /// </summary>
        /// <param name="env">Instanca <see cref="IWebHostEnvironment"/> koja sadr�i informacije o web okru�enju.</param>
        ...
        /// <param name="fileName">Ime datoteke s kojom �e slika biti spremljena.</param>
        /// <returns>Vra�a URL slike za pristup preko weba.</returns>
